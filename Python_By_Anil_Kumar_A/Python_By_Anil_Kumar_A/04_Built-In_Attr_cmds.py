...
print('Checking for attribute "seat_count". True|False: ', hasattr(car_01, 'seat_count'))

print('Checking for attribute "seat_count". True|False: ', hasattr(car_01, 'car_color'))
setattr(car_01, 'car_color', 'Yellow')
car_01.displayCars()

print('Get attribute verification for car_01.model_name: ', getattr(car_01, 'model_name'))
print('Get attribute verification for car_01.model_name: ', getattr(car_01, 'wheel_brand'))
delattr(car_01, 'wheel_brand')
print('Checking for attribute "wheel_brand". True|False: ', hasattr(car_01, 'wheel_brand'))
